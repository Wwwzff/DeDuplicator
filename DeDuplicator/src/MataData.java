...
//    directory_path_record [dir_name: [filepath: filename]]
    ...
    * */
    public String print_dir_rec() {
        String output = "";
        for (String currentKey: dir_path_rec.keySet()) {
            System.out.print(currentKey+": ["); // dir name
            output = output + currentKey+": [";
            for (String currKey: dir_path_rec.get(currentKey).keySet()) {
                System.out.print(currKey+": "); // file path
                output = output + "   "+currKey+": ";
                System.out.print(dir_path_rec.get(currentKey).get(currKey)+", ");
                output = output + dir_path_rec.get(currentKey).get(currKey)+",\n";
            }
            System.out.print("] ");
            System.out.println();
            output = output + "]\n";
